...
<div class="companies form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <fieldset>
            ...
            echo $this->Form->control('location.latitube', ['id'=>'lat','type'=>'hidden','value'=>$company->location->latitube]);
            echo $this->Form->control('location.longitube', [ 'id'=>'lng','type'=>'hidden','value'=>$company->location->longitube]);
            ?>
            <?php
